...
import { Box, Link, Card, Grid, Avatar, Typography, CardContent, IconButton, Button } from '@mui/material';
...
export default function BlogPostCard({ post, index }) {
  ...
  return (
    <Grid item xs={12} sm={latestPostLarge ? 12 : 6} md={latestPostLarge ? 6 : 3}>
      <ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal" sx={{ position: 'relative' }}>
        {/* BACK OF THE CARD - COURSE DESCRIPTION */}
        <Card>
          <StyledCardMedia
            sx={{
          ...
          >
            ...
            <Typography onClick={handleClickFlipCard} sx={{ cursor: 'pointer', color: 'text.disabled', display: 'block' }}>
              Course description ...
            </Typography>
        ...
        <Card>
            ...
            sx={{
              ...((latestPostLarge || latestPost) && {
                ...
                '&:after': {
                  ...
                  height: '100%',
                  position: 'absolute',
                  background: 'linear-gradient(45deg, rgba(133, 0, 207, 0.65), rgb(245, 177, 15) 180%)',
                  // bgcolor: (theme) => alpha(theme.palette.grey[900], 0.72),
                },
              }),
              ...(latestPostLarge && {
          ...
          >
            ...
            <Button onClick={handleClickFlipCard} sx={{ cursor: 'pointer', display: 'block', color: ' #fff' }}>
              Back
            </Button>
          </CardContent>
